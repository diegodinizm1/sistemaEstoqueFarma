...
public class RelatorioService {
    ...
    public RespostaRelatorioPivoteado gerarRelatorioSaidaDiariaPivoteado() {
        ...
        // 2. Busca as movimentações de saída do dia
        var inicioDoDia = LocalDate.now().atStartOfDay();
        var fimDoDia = LocalDate.now().atTime(LocalTime.MAX);
